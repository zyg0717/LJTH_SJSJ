...
$HGRootNS._ClientMsg.prototype = 
{
	...
	_popMsgWindow : function(msgType, msg, detailMsg, title, okBtnText, cancelBtnText, okBtnMethod, cancelBtnMethod)
	{
		...
		var bResult = window.showModalDialog("<%=WebResource("MCS.Web.Library.Resources.ClientMsg.WebMsgBox.htm")%>", arg, "dialogHeight:126px;dialogWidth:209px;help:no;scroll:no;status:no");
