...
namespace Framework.Web
{
    ...
    public static class WindowFeatureHelper
    {
        ...
        /// <param name="windowFeature"></param>
        /// <returns></returns>
        public static string GetDialogFeatureClientString(IWindowFeature windowFeature)
        {
            return GetDialogFeatureClientString(windowFeature, QuatationMarkType.Single);
        }
        ...
        /// <returns></returns>
        public static string GetDialogFeatureClientString(IWindowFeature windowFeature, QuatationMarkType quatationMarkType)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetWindowFeatureClientString(IWindowFeature windowFeature, QuatationMarkType quatationMarkType)
        {
            StringBuilder strB = new StringBuilder(256);
