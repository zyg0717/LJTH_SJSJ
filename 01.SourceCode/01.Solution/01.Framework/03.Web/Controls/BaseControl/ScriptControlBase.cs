...
namespace Framework.Web.Controls
{
    ...
    public class ScriptControlBase : WebControl, IScriptControl, INamingContainer, IControlResolver, IPostBackDataHandler, IPostBackEventHandler, ICallbackEventHandler, IClientStateManager
    {
        #region [ Constructor ]
        ...
        {
            get { return GetPropertyValue<bool>("InvokeWithoutViewState", false); }
