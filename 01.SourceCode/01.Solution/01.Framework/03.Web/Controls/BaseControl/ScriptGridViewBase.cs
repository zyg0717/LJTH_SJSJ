...
namespace Framework.Web.Controls
{
    ...
    public class ScriptGridViewBase : GridView, IScriptControl, INamingContainer, IControlResolver, IPostBackDataHandler, ICallbackEventHandler, IClientStateManager
    {
        #region [ Constructor ]
        /// <summary>
        /// 
