...
[assembly: WebResource("Framework.Web.Controls.LibGridView.DeluxeGrid.js", "application/x-javascript")]
[assembly: WebResource("Framework.Web.Controls.LibGridView.DeluxeGrid.css", "text/css", PerformSubstitution = true)]
[assembly: WebResource("Framework.Web.Controls.LibGridView.excel.gif", "image/gif")]
[assembly: WebResource("Framework.Web.Controls.LibGridView.word.gif", "image/gif")]
namespace Framework.Web.Controls
{
    ...
    /// </remarks>
    //引用所需的Css
    [ClientCssResource("Framework.Web.Controls.LibGridView.DeluxeGrid.css")]
    ...
    [ClientScriptResource("Framework.Web.Controls.DeluxeGrid", "Framework.Web.Controls.LibGridView.DeluxeGrid.js")]
    public class DeluxeGrid : ScriptGridViewBase
    {
        /// <summary>
        /// 用于设计态
        /// </summary>
        ...
        private string ExcelImgUrl
        {
            get
            {
                return Page.ClientScript.GetWebResourceUrl(typeof(DeluxeGrid),
                        "Framework.Web.Controls.LibGridView.excel.gif");
            }
        }
        ...
        private string WordImgUrl
        {
            ...
            {
                return Page.ClientScript.GetWebResourceUrl(typeof(DeluxeGrid),
                        "Framework.Web.Controls.LibGridView.word.gif");
            }
        }
        ...
        public bool ShowCheckBoxs
        {
            get
            {
                return WebControlUtility.GetViewStateValue<bool>(ViewState, "ShowCheckBoxs", false);
            }
            set
            {
                WebControlUtility.SetViewStateValue<bool>(ViewState, "ShowCheckBoxs", value);
            }
        }
        ...
        protected override int CreateChildControls(IEnumerable dataSource, bool dataBinding)
        {
            ...
            {
                //if (this.ShowCheckBoxs || this.ShowExportControl)
                //{
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            BindGridTitle();
            //增加checkbox模版列
            //if (this.ShowCheckBoxs && !this.DesignMode)
        ...
        {
            this.selectedKeys = JsonHelper.Deserialize<List<string>>(clientState);
            /*
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (this.ExportingDeluxeGrid && this.ShowCheckBoxs)
            {
                if (this.CheckBoxPosition == RowPosition.Left)
