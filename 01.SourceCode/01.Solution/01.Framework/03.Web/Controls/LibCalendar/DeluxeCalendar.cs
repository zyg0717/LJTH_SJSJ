...
[assembly: System.Web.UI.WebResource("Framework.Web.Controls.LibCalendar.DeluxeCalendar.js", "text/javascript", PerformSubstitution = true)]
[assembly: System.Web.UI.WebResource("Framework.Web.Controls.LibCalendar.DeluxeCalendar.css", "text/css", PerformSubstitution = true)]
[assembly: System.Web.UI.WebResource("Framework.Web.Controls.LibCalendar.Images.arrow-left.gif", "image/gif")]
[assembly: System.Web.UI.WebResource("Framework.Web.Controls.LibCalendar.Images.arrow-right.gif", "image/gif")]
[assembly: System.Web.UI.WebResource("Framework.Web.Controls.LibCalendar.Images.caption.gif", "image/gif")]
[assembly: System.Web.UI.WebResource("Framework.Web.Controls.LibCalendar.Images.datePicker.gif", "image/gif")]
[assembly: System.Web.UI.WebResource("Framework.Web.Controls.LibCalendar.Images.updown.gif", "image/gif")]
[assembly: System.Web.UI.WebResource("Framework.Web.Controls.LibCalendar.Images.checked.gif", "image/gif")]
[assembly: System.Web.UI.WebResource("Framework.Web.Controls.LibCalendar.Images.today.gif", "image/gif")]
...
namespace Framework.Web.Controls
{
    ...
    [ClientCssResource("Framework.Web.Controls.LibCalendar.DeluxeCalendar.css")]
    [ClientScriptResource("Framework.Web.Controls.DeluxeCalendar", "Framework.Web.Controls.LibCalendar.DeluxeCalendar.js")]
    public class DeluxeCalendar : ScriptControlBase
    {
        ...
        {
            get { return Page.ClientScript.GetWebResourceUrl(typeof(DeluxeCalendar), "Framework.Web.Controls.LibCalendar.Images.datePicker.gif"); }
        }
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            else
            {
                ...
                writer.Write("<img type='image' id='{0}' src='{1}' class='{2}' style='{3};cursor:hand' tabindex='-1' align='absmiddle' />",
                    this.UniqueID + "_image", (ImageUrl == string.Empty) ? DefaultImageUrl : ResolveUrl(ImageUrl), ImageCssClass, ImageStyle,
                    this.ReadOnly ? "onclick='return false;'" : string.Empty);//无法在客户端继续将控件激活操作
                //writer.Write("<input type='image' id='{0}' src='{1}' class='{2}' style='{3}' tabindex='-1' align='absmiddle' {4}/>",
                //    this.UniqueID + "_image", (ImageUrl == string.Empty) ? DefaultImageUrl : ResolveUrl(ImageUrl), ImageCssClass, ImageStyle,
                //    this.ReadOnly ? "onclick='return false;'" : string.Empty);//无法在客户端继续将控件激活操作
            }
        }
