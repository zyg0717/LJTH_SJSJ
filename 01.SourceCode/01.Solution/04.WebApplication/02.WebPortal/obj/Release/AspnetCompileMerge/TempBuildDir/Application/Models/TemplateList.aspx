<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster/PageLayout.master" AutoEventWireup="true" CodeBehind="TemplateList.aspx.cs" Inherits="WebApplication.WebPortal.Application.Models.TemplateList" %>
...
<asp:Content ContentPlaceHolderID="page_contents" runat="server">
    <div id="templateList" v-cloak>
        ...
        <div class="template-wrap gray-wrap" v-cloak>
            <div v-if="!isMobile" class="task-tt">
                <span class="icon-tag"><i class="fa fa-tag"></i>&nbsp;我的模板</span>
                <div class="view-all  <%=IsHasAllTemplate?"":"hidden" %>">
                    <a class="icon-template" href="<%=ResolveUrl("~/Application/Admin/AdminTemplateList.aspx") %>">全部模板</a>
                </div>
            </div>        
            <div v-if="!isMobile" class="template-search clear">
                ...
                <div class="col-md-2 col-xs-6 col-sm-2 mgb15">
                    <a href="<%=ResolveUrl("~/Application/Models/TemplateModel.aspx") %>" class="btn btn-info add-template create-task form-control" style="margin-top: -2px;"><span><i class="fa fa-plus"></i>&nbsp;新增模板</span></a>                 
                </div> 
            </div>

            <div v-if="isMobile" class="template-search clear pdt15">
                <div class="col-md-6 col-xs-6 col-sm-9 mgb15">
                ...
                <div class="col-md-6 col-xs-6 col-sm-3 mgb15" v-cloak>
                    <div class="select-container">
                ...
                <!--<div class="col-md-2 col-xs-6 col-sm-2 text-center template-chk">
                    ...
                    <label class="control-label chk-label" for="myTemplate"><span>只看我的模板</span></label>
                </div>-->
            </div>
            ...
            <div class="list-empty text-center" v-show="total === 0 && !isLoading" v-cloak>
                <p><span class="mgr20">您还没有创建模板!</span></p>
            </div>          
            <div class="page-data-pager text-center">
...
<asp:Content ContentPlaceHolderID="page_scripts" runat="server">
    ...
    <script src="<%=ResolveUrl("~/Assets/scripts/Models/TemplateList.js") %>"></script>
</asp:Content>
